...
export const metadata: Metadata = {
  ...
  other: {
    ...
    citation_keywords:
      ...
      "interpretive variation; synthetic personas",
  },
};
...
const abstract =
  "This study examines how persona prompting shapes language generated by two " +
  "multimodal large language models in urban perception, a setting for examining " +
  "subjective interpretations of shared visual evidence. We organize outputs into " +
  "three functional levels: descriptive grounding (captions), intermediate semantic " +
  "layer (perception tags), and interpretive framing (justifications). Using " +
  "approximately 60,000 persona-conditioned annotations per model from Qwen3-VL-8B " +
  "and Gemma-4-E4B-it, we find that captions converge strongly across persona " +
  "profiles and show only small attribute-associated differences. Justifications " +
  "vary substantially more: economic status produces the largest difference in both " +
  "models, with political orientation and personality also prominent. Paired " +
  "image-level comparisons confirm larger justification than caption differences for " +
  "these three attributes. For perception tags, personas sharing the same attribute " +
  "level produce more similar tag sets than personas with different attribute levels, " +
  "with the largest separation observed for economic status. Exploratory topic " +
  "analysis further reveals persona-specific evaluative emphasis. Across models, " +
  "profile-pair similarity patterns are strongly correlated for all three output " +
  "types, although agreement is lowest for justifications. Overall, persona prompting " +
  "affects interpretive framing more strongly than descriptive grounding.";

const affiliationNames: Record<string, string> = {
  "1": "University of Toronto",
  "2": "Federal University of Technology – Parana (UTFPR)",
};
...
export default function Home() {
  const structuredData = {
    ...
    publication: { "@type": "PublicationEvent", name: venue, url: workshopUrl },
    inLanguage: "en",
    license: "https://arxiv.org/abs/2605.29064",
        ...
        <div className="content-narrow">
          ...
          <div className="paper-actions" aria-label="Paper resources">
            ...
            <a href={doiUrl} target="_blank" rel="noreferrer">
              <b>DOI</b><span>Soon</span>
            </a>
            <a href="#cite">
              <b>BIB</b><span>Citation</span>
            </a>
            <a href={codeUrl} target="_blank" rel="noreferrer">
              <b className="icon-github" aria-hidden="true">
            ...
            <a href={datasetUrl} target="_blank" rel="noreferrer">
              <b className="icon-emoji" aria-hidden="true">🤗</b>
              <span>Dataset</span>
            </a>
          </div>
        </div>
